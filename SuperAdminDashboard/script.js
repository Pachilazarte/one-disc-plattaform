/**
 * 👑 SUPER ADMIN DASHBOARD — DISC
 * Actualizado con flujo de creación de infraestructura multi-tenant
 */
...
/* =========================================================
   CREAR ADMIN — con infraestructura multi-tenant
   ========================================================= */
async function handleCreateAdmin(e) {
    ...
    showConfirmModal({
        ...
        onConfirm: async function () {
            ...
            // 2. Crear infraestructura vía GET (CORS-safe)
            try {
        ...
        return '<tr class="' + (estado === 'inactivo' ? 'opacity-60' : '') + ' hover:bg-white/5 transition-colors">' +
            ...
            '<td class="px-3 py-3">' +
                '<div class="action-buttons">' +
                    ...
                    '</button>' +
                    '<button class="btn-action btn-action-reset" onclick="resetAdminPassword(\'' + sanitize(usuario) + '\')" title="Reset contraseña">' +
