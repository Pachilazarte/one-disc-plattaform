 ...
 *  - Gráfico de barras DISC dibujado manualmente (fallback sin canvas)
 * ============================================================================
 */
...
/**
 * Dibuja el gráfico de barras DISC de forma programática (sin canvas).
 * Se usa como fallback cuando no está disponible el elemento canvas del DOM.
 *
 * @param {object} doc
 * @param {number} x          - Posición X de inicio
 * @param {number} y          - Posición Y de inicio
 * @param {{ D, I, S, C }} discValues - Valores 0-100 para cada dimensión
 */
export function dibujarGraficoBarrasManual(doc, x, y, discValues, width = 180) {
  const maxHeight = 90;
