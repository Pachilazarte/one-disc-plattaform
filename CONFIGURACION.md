...
5. Configura:
   - **Descripción:** "API Backend del Sistema DISC"
...
api: {
    ...
    testDISC: "https://script.google.com/macros/s/ABC123.../exec"
}
```
...
**¡Listo! Tu sistema DISC ya está configurado y listo para usar.**
